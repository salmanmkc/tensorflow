...
class SingleDeviceShardingSpecSerDes
 ...
 public:
  ...
  absl::StatusOr<std::string> Serialize(
    ...
    const SingleDeviceShardingSpec& sharding_spec =
        llvm::cast<SingleDeviceShardingSpec>(serializable);
    SingleDeviceShardingSpecProto proto;
    proto.set_version_number(SerDesVersionNumber(0).value());
    if (sharding_spec.memory_kind().memory_kind().has_value()) {
      // OSS requires explicit string conversion
      // NOLINTBEGIN(*-redundant-string-conversions)
      proto.set_memory_kind(
          std::string(*sharding_spec.memory_kind().memory_kind()));
  ...
  absl::StatusOr<std::unique_ptr<Serializable>> Deserialize(
    ...
    return SingleDeviceShardingSpec::Create(memory_kind);
  }
...
class OpaqueShardingSpecSerDes
 ...
 public:
  ...
  absl::StatusOr<std::unique_ptr<Serializable>> Deserialize(
    ...
    return OpaqueShardingSpec::Create(proto.num_shards(), memory_kind);
  }
 ...
 public:
  ...
  absl::StatusOr<std::unique_ptr<Serializable>> Deserialize(
    ...
    if (proto.has_shape()) {
      ...
      return ConcreteShardingSpec::Create(proto.num_shards(), memory_kind,
                                          std::move(shape),
 ...
 public:
  ...
  absl::StatusOr<std::unique_ptr<Serializable>> Deserialize(
    ...
    return ConcreteEvenShardingSpec::Create(
        proto.num_shards(), memory_kind, std::move(shape),
...
class ShardingParamShardingSpecSerDes
 ...
 public:
  ...
  absl::StatusOr<std::unique_ptr<Serializable>> Deserialize(
    ...
    return ShardingParamShardingSpec::Create(proto.num_shards(), memory_kind,
